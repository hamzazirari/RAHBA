...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:items-start">
        ...
        <form action="#" method="POST" class="lg:col-span-7 space-y-6">
            @csrf
            ...
            <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-xs space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="name" required placeholder="Ex: Hamza ..." 
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-700 uppercase mb-2">Téléphone (Obligatoire pour la livraison)</label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="address" required placeholder="Rue, Numéro d'appartement, Quartier..." 
                            class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:bg-white focus:border-amber-500 focus:ring-2 focus:ring-amber-200 transition outline-hidden">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-xs space-y-4">
                ...
                <label class="flex items-start gap-4 p-4 bg-amber-50/50 border border-amber-200 rounded-xl cursor-pointer select-none">
                    ...
                    <div>
                        <span class="block text-sm font-bold text-slate-900">Paiement à la livraison (Cash on Delivery)</span>
                        <span class="block text-xs text-slate-500 mt-0.5">Payez en espèces dès que le livreur frappe à votre porte.</span>
                    </div>
                </label>
            </div>
        </form>
        ...
        <section class="lg:col-span-5 mt-8 lg:mt-0 bg-white p-6 rounded-2xl border border-slate-100 shadow-xs">
            <h2 class="text-lg font-bold text-slate-900 border-b border-slate-100 pb-4 mb-4">Récapitulatif</h2>
            
            <div class="space-y-3 max-h-60 overflow-y-auto pr-2 mb-4">
                <div class="flex items-center gap-3 py-1">
                    <img src="https://images.unsplash.com/photo-1560393464-5c69a73c5770?w=100" class="w-12 h-12 rounded-lg object-cover bg-slate-50 border">
                    <div class="flex-1 min-w-0">
                        <h4 class="text-xs font-bold text-slate-800 truncate">Souris Gaming Sans Fil RGB</h4>
                        <span class="text-[11px] text-slate-400">Quantité: 1</span>
                    </div>
                    <span class="text-xs font-black text-slate-900">350.00 DH</span>
                </div>
            </div>
            ...
            <div class="space-y-3 text-sm border-t border-slate-100 pt-4">
                ...
                <div class="border-t border-slate-100 pt-4 flex justify-between text-base font-black text-slate-900">
                    ...
                    <span class="text-xl text-amber-600">350.00 DH</span>
                </div>
            </div>

            <button type="submit" class="w-full mt-6 bg-amber-600 hover:bg-amber-700 text-white font-bold py-3.5 px-4 rounded-xl transition shadow-xs cursor-pointer text-center">
