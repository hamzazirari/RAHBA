<header class="bg-white border-b border-slate-100 shadow-xs sticky top-0 z-50">
    <div class="bg-slate-900 text-slate-300 text-xs py-2 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        <div class="flex gap-4">
            ...
            <a href="#" class="text-amber-400 font-bold hover:text-amber-500 transition">Devenir Vendeur</a>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20 gap-4">
            ...
            <div class="flex items-center gap-4">
                <a href="#" class="text-sm font-bold text-slate-700 hover:text-amber-600 px-4 py-2.5 border border-slate-200 rounded-xl transition">
    ...
    <nav class="bg-slate-50 border-t border-slate-100 hidden sm:block">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex gap-6 py-3 text-sm font-semibold text-slate-600">
            <a href="#" class="hover:text-amber-600 transition text-amber-600 flex items-center gap-1"><i class="fa-solid fa-border-all"></i> Tout le catalogue</a>
